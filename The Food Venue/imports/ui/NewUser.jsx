    ...
    return (
      <div>
        User Information
          ...
          <br /><br /><br /><br />
          <label for="name">Name: </label><input name="name" type="text" ref="userName" aria-label="User name" required />
          <br />
          <label for="country">Country: </label>
          <select name="country" ref="userCountry" aria-label="Recipe country" required>
          ...
          <br />
          <label for="gender">Gender: </label> <select required
              name="gender"
              ref="userGender"
